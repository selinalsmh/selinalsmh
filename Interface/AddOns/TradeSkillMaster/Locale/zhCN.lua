...
L["Auctioning's CancelAll scan can be used to quickly cancel specific items. Anything from items under a certain duration to specific items, to entire groups."] = "拍卖部中的条件撤销可以在搜索时快速撤销特定物品，如：特定拍卖期內的物品、某件特定物品，或者整个群组。" -- Needs review
L["Author(s):"] = "作者："
...
L["Crafting can make Auctioning groups for you. Just click on a profession icon, a category, and then the \"Create Auctioning Groups\" button."] = "生产部可以为你建立制作拍卖部群组。只需点击专业技能图标，点击分类，然后点击\"创建拍卖群组\"即可。" -- Needs review
...
L["If the Craft Management Window is too big, you can scale it down in the Crafting options."] = "你可以在制作选项中按比例缩小制作管理窗口。" -- Needs review
...
L["The only required module of TradeSkillMaster is the main one (TradeSkillMaster). All others may be disabled if you are not using them."] = "TradeSkillMaster唯一必须载入的模块只有主程序(TradeSkillMaster)。所有其他模块在不需要的情况下都可以被关闭。" -- Needs review
...
L["There is an option for hiding Auctioning's advanced options in the top \"Options\" page of the Auctioning page in the main TSM window."] = "在TSM主窗口拍卖部页面最上方的\"选项\"中，可以关闭拍卖部的高级选项。" -- Needs review
