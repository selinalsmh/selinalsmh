...
function TSM:LoadTooltip(itemID)
	...
	if TSM.db.profile.tooltip == "simple" then
		...
		tinsert(text, format("  "..L["ItemTracker: %s on player, %s on alts, %s in guild banks, %s on AH"], "|cffffffff"..player.."|r", "|cffffffff"..alts.."|r", "|cffffffff"..guild.."|r", "|cffffffff"..auctions.."|r"))
